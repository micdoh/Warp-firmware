...
warp:
	...
	cp src/boot/ksdk1.1.0/sin1.*				build/ksdk1.1/work/demos/Warp/src/
	cd build/ksdk1.1/work/lib/ksdk_platform_lib/armgcc/KL03Z4 && ./clean.sh; ./build_all.sh
	cd build/ksdk1.1/work/demos/Warp/armgcc/Warp && ./clean.sh; ./build_all.sh
	@echo "\n\nNow, run\n\n\tmake load-warp\n\n"
